...
try:
    ...
    pass
import pytest
from ote.api.test_suite.pytest_insertions import (
    get_pytest_plugins_from_ote,
    ote_conftest_insertion,
    ote_pytest_addoption_insertion,
    ote_pytest_generate_tests_insertion,
)
from ote.api.test_suite.training_tests_common import REALLIFE_USECASE_CONSTANT

pytest_plugins = get_pytest_plugins_from_ote()

ote_conftest_insertion(
    default_repository_name="ote/training_extensions/external/anomaly"
)
...
def ote_test_domain_fx():
    raise NotImplementedError(
        "Please, implement the fixture ote_test_domain_fx in your test file"
    )
