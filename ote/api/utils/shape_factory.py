...
from ote.api.entities.shapes.shape import ShapeEntity
...
class ShapeFactory:
    ...
    def shape_as_rectangle(shape: ShapeEntity) -> Rectangle:
        ...
        >>> from ote.api.entities.dataset_item import DatasetItem
        >>> from ote.api.entities.image import NullImage
        >>> from ote.api.entities.annotation_scene import NullAnnotationScene
