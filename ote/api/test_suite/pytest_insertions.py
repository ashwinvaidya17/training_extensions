...
def get_pytest_plugins_from_ote():
    ...
    """
    import ote.api.test_suite.fixtures  # noqa

    pytest_plugins_from_ote_api = ["ote.api.test_suite.fixtures"]
    pytest_plugins = list(_pytest_plugins_from_e2e) + pytest_plugins_from_ote_api
