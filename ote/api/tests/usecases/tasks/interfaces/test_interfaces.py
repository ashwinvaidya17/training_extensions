...
from ote.api.usecases.tasks.interfaces.inference_interface import (
    IInferenceTask,
    IRawInference,
)
...
class TestIEvaluationTask:
    ...
    @patch(
        "ote.api.usecases.tasks.interfaces.evaluate_interface.IEvaluationTask.__abstractmethods__",
        set(),
    )
...
class TestIInferenceTask:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.inference_interface.IInferenceTask.__abstractmethods__",
        set(),
    )
...
class TestIRawInference:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.inference_interface.IRawInference.__abstractmethods__",
        set(),
    )
...
class TestIOptimizationTask:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.optimization_interface.IOptimizationTask.__abstractmethods__",
        set(),
    )
...
class TestITrainingTask:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.training_interface.ITrainingTask.__abstractmethods__",
        set(),
    )
...
class TestIUnload:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.unload_interface.IUnload.__abstractmethods__",
        set(),
    )
...
class TestIExportTask:
    ...
    @pytest.mark.reqids(Requirements.REQ_1)
    @patch(
        "ote.api.usecases.tasks.interfaces.export_interface.IExportTask.__abstractmethods__",
        set(),
    )
