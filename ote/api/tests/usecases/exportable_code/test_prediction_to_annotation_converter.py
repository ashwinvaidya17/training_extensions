...
from ote.api.entities.label import Color, Domain, LabelEntity
from ote.api.entities.label_schema import LabelGroup, LabelSchemaEntity
...
class TestIPredictionToAnnotation:
    ...
    @patch(
        (
            "ote.api.usecases.exportable_code.prediction_to_annotation_converter."
