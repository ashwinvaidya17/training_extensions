...
from ote.api.configuration.elements.primitive_parameters import (
    boolean_attribute,
...
from ote.api.configuration.enums import AutoHPOState, ConfigElementType, ModelLifecycle
from ote.api.configuration.ui_rules import NullUIRules, Rule, UIRules
