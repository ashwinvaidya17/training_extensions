...
from ote.api.entities.datasets import Subset
from ote.api.entities.inference_parameters import InferenceParameters
from ote.api.entities.model import ModelEntity, ModelPrecision, ModelOptimizationType
...
def parse_args():
    ...
    parser.add_argument(
        "--weights", help="path to the pre-trained model weights", default=None
    )
    parser.add_argument(
        "--aux-weights", help="path to the pre-trained aux model weights", default=None
    )
